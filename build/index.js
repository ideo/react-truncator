...
var Truncator = function (_React$Component) {
  _inherits(Truncator, _React$Component);

  function Truncator(props) {
    _classCallCheck(this, Truncator);

    var _this = _possibleConstructorReturn(this, (Truncator.__proto__ || Object.getPrototypeOf(Truncator)).call(this, props));

    _this._onResize = function () {
      _this.setState({ truncated: false }, function () {
        _this.truncate();
      });
    };
    ...
    _this.truncate = function () {
      ...
      if (lettersToRemove > 1) {
        ...
        var mid = parseInt((text.length - lettersToRemove) / 2);
        var first = text.slice(0, mid);
        var rest = text.slice(mid + lettersToRemove, text.length);
        var truncated = first + '\u2026' + rest;
    ...
    _this.onResize = _lodash2.default.debounce(_this._onResize, 100);
    return _this;
  }
